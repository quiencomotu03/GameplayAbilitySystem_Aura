...
TArray<FVector> UAuraSummonAbility::GetSpawnLocations()
{
	...
	for(int32 i=0; i<NumMinions;i++)
	{
		...
		//DrawDebugSphere(GetWorld(), ChosenSpawnLocation, 18.f, 12, FColor::Red);
		//UKismetSystemLibrary::DrawDebugArrow(GetAvatarActorFromActorInfo(), Location, Location+Direction *
		//	MaxSpawnDistance, 4.f, FLinearColor::Green, 3.f);
...
TSubclassOf<class APawn> UAuraSummonAbility::GetRandomMinionClass()
{
